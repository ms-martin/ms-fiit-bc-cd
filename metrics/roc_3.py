...
import numpy as np
import os
import models.model_f3_c64_c128_d4096_o256 as model1
import models.model_f7_c64_c128_d4096_o256 as model2
import models.model_f11_c64_c128_d4096_o256 as model3
import models.model_c64_c128_d4096_o256 as model4

import dataprep.ilidsvid_seq as dataset

model_paths = ['model_f3_c64_c128_d4096_o256',
               'model_f7_c64_c128_d4096_o256',
               'model_f11_c64_c128_d4096_o256',
...
plt.savefig('results/roc_aggregate_fx_c64_c128.png')
plt.close()

with open("results/metrics_aggregate_fx_c64_c128.txt", "w") as file:
    for model in range(len(model_paths)):
