...
class Siamese:
    ...
    def convnet(self, inputx, training):
        input_reshaped = tf.reshape(inputx, [self.batch_size, 128, 64, 3])
        ...
        spp = self.spp_layer(conv2, [8, 4, 2, 1], 'spp')

        dense1 = self.fc_layer(spp, 4096, "dense1")
    ...
    def spp_layer(self, input_, levels, name):
        ...
        with tf.variable_scope(name):
            ...
            spp_pool = tf.reshape(spp_pool, [self.batch_size, -1])
            return spp_pool
