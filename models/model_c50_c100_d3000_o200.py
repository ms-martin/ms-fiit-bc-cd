...
class Siamese:
    ...
    def convnet(self, inputx, training):
        ...
        conv1 = self.conv_layer(input_reshaped, [5, 5, 3, 50], [50], "conv1")
        ...
        conv2 = self.conv_layer(max1, [5, 5, 50, 100], [100], "conv2")
        ...
        max2flat = tf.reshape(max2, [-1, 32 * 16 * 100], name="max2flat")

        dense1 = self.fc_layer(max2flat, 3000, "dense1")
        ...
        out = self.fc_layer(dropout1, 200, "dense2")
        return out
