...
class Siamese:
    ...
    def convnet(self, inputx, training):
        ...
        conv1 = self.conv_layer(input_reshaped, [5, 5, 3, 128], [128], "conv1")
        ...
        conv2 = self.conv_layer(max1, [5, 5, 128, 256], [256], "conv2")
        ...
        max2flat = tf.reshape(max2, [-1, 32 * 16 * 256], name="max2flat")
        ...
        out = self.fc_layer(dropout1, 256, "dense2")
        return out
