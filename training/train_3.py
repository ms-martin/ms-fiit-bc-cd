...
import models.model_c32_c64_spp_d4096_o128 as model
import dataprep.ilidsvid_seq as dataset

model_name = 'model_c32_c64_spp_d4096_o128'

sess = tf.InteractiveSession()

siamese = model.Siamese(True, 200)
...
for step in range(1000000):
    batch_x1, batch_x2, batch_y = dataset.get_augmented_batch(siamese.batch_size, True)
